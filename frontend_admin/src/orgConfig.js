...
const CINEMA_CONFIG = {
  ...
  theme: {
    sidebar: "bg-[#52164f]",
    sidebarText: "text-[#f7f7f7]",
    sidebarMuted: "text-[#f3dff1]/75",
    sidebarAccent: "text-[#f3dff1]",
    pageBg: "bg-[#f7f7f7]",
    hoverBg: "hover:bg-[#f3dff1]/18",
    hoverText: "hover:text-[#f7f7f7]",
    navActive: "bg-[#d77aca]/22 text-[#f7f7f7] border border-[#d77aca]/34",
    navIdle: "text-[#f3dff1]/82 hover:bg-[#f3dff1]/12 hover:text-[#f7f7f7]",
    activeNav: "bg-[#d77aca]/22 text-[#f7f7f7] border border-[#d77aca]/34",
    idleNav: "text-[#f3dff1]/82 hover:bg-[#f3dff1]/12 hover:text-[#f7f7f7]",
    hero: "from-[#f7f7f7] via-[#f7f7f7] to-[#f3dff1]",
    heroEyebrow: "border-[#d77aca]/24 bg-[#f3dff1] text-[#52164f]",
    primaryButton: "bg-[#52164f] hover:bg-[#6a2167] text-[#f7f7f7] shadow-[#52164f]/14",
    panelBorder: "border-[#e8cfe5]",
    panelBg: "bg-[#f7f7f7]",
    tag: "bg-[#f3dff1] text-[#52164f] border border-[#d77aca]/22",
    card: "border-[#e8cfe5] bg-[#f7f7f7]",
    panelSoft: "border-[#e8cfe5] bg-[#f7f7f7]/90 backdrop-blur-sm",
    heroDark: "border-[#e8cfe5] bg-[#f7f7f7]",
    buttonPrimary: "bg-[#52164f] hover:bg-[#6a2167] text-[#f7f7f7]",
    buttonSecondary:
      "border border-[#d77aca]/30 text-[#52164f] bg-[#f7f7f7] hover:bg-[#f3dff1] shadow-sm",
    textStrong: "text-[#2d252b]",
    textSoft: "text-[#6f5c6c]",
    seatAvailable: "bg-[#d77aca]",
    seatBlocked: "bg-[#d8cfd6]",
    seatBroken: "bg-[#52164f]",
    input:
      "border-[#e8cfe5] bg-[#f7f7f7] text-[#2d252b] focus:border-[#d77aca] focus:bg-white focus:ring-4 focus:ring-[#f3dff1]",
    modalCard: "border-[#e8cfe5] bg-[#f7f7f7]",
    modalSurface: "border-[#e8cfe5] bg-[#f3dff1]/34",
    modalMuted: "text-[#6f5c6c]",
    buttonDanger: "bg-[#52164f] hover:bg-[#6a2167] text-[#f7f7f7]",
    buttonWarning: "bg-[#d77aca] hover:bg-[#ca69bd] text-[#52164f]",
    buttonGhost: "border-[#e8cfe5] bg-[#f7f7f7] text-[#52164f] hover:bg-[#f3dff1]",
    buttonNeutral: "bg-[#d77aca] hover:bg-[#ca69bd] text-[#52164f]",
    tagMuted: "border border-[#e8cfe5] bg-[#f7f7f7] text-[#6f5c6c]",
    highlightTag: "border border-[#d77aca]/30 bg-[#f3dff1] text-[#52164f]",
    aisle: "bg-[#f3dff1]/55",
    seatAvailableClass:
      "border-[#d77aca]/55 bg-[#f3dff1] hover:bg-[#efd2ea]",
    seatBlockedClass:
      "border-[#d8cfd6] bg-[#f7f7f7]",
    seatBrokenClass: "border-[#52164f]/36 bg-[#f3dff1]",
    metricCards: {
      blue: "border-[#e8cfe5] bg-[#f7f7f7] text-[#52164f] shadow-[#f3dff1]/70",
      sky: "border-[#e8cfe5] bg-[#f3dff1] text-[#52164f] shadow-[#f3dff1]/70",
      emerald:
        "border-[#e8cfe5] bg-[#f7f7f7] text-[#6f5c6c] shadow-[#f3dff1]/70",
      amber: "border-[#d77aca]/30 bg-[#f3dff1] text-[#52164f] shadow-[#f3dff1]/70",
      violet:
        "border-[#d77aca]/34 bg-[#f3dff1] text-[#52164f] shadow-[#f3dff1]/70",
    },
  },
};
